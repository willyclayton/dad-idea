    ...
    <div className="min-h-screen bg-gray-50 py-10 md:py-16 px-5">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8 md:mb-10">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Choose your plan</h1>
        ...
        <p className="text-xs text-gray-400 text-right mb-7">Step 2 of 3</p>
        ...
        <form action="/api/checkout" method="POST">
          ...
          <button
            type="submit"
            className="w-full bg-brand-600 hover:bg-brand-700 text-white font-semibold py-3.5 rounded-xl text-sm transition-colors"
          >
            Continue to payment
          </button>
        </form>
