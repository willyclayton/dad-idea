          ...
          <div className="grid md:grid-cols-3 gap-10">
            {STEPS.map((step) => (
              <div key={step.number} className="text-center">
                <div className="text-5xl font-black text-brand-200 mb-4">{step.number}</div>
      ...
      <section className="py-16 bg-brand-50 border-y border-brand-100">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed max-w-2xl mx-auto">
            ...
            contractors and manufacturers improve their products and services. This is always opt-in,
            always anonymized, and you can opt out at any time from your dashboard — without
